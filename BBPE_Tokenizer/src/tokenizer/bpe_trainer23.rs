...
impl Ord for Merge {
    fn cmp(&self, other: &Self) -> Ordering {
        ...
        self.count.cmp(&other.count)
            ...
            .then_with(|| other.merged_string.cmp(&self.merged_string))
    }
}
...
impl BpeTrainer {
    ...
    fn compute_alphabet(
        ...
        let mut initial_byte_chars: Vec<String> = (0u8..=255u8)
            .map(|i| byte_map[&i].to_string())
            .collect();

        initial_byte_chars.sort_unstable(); 
